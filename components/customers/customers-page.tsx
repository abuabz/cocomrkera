    ...
    <div className="p-4 md:p-6 bg-background min-h-screen w-full">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 md:mb-8 gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-black text-primary tracking-tight">Customers Matrix</h1>
            <p className="text-xs md:text-sm text-muted-foreground mt-1 font-bold uppercase tracking-widest opacity-60">Directory & Harvest History</p>
          </div>
          <Button
            onClick={() => {
